      ...
      <div className="row">
        <div className="span12">
          <div className="row-fluid">
            ...
            <p>
              Telefeast ("us", "we", or "our") operates the
              https://telefeast.com/ website (the "Service").
            </p>
            ...
            <p>
              ...
              for Telefeast is created with the help of the{" "}
            ...
            <p>Telefeast uses the collected data for various purposes:</p>
            <ul>
            ...
            <p>
              Telefeast will take all steps reasonably necessary to ensure that
            ...
            <p>
              Telefeast may disclose your Personal Data in the good faith belief
              that such action is necessary to:
            </p>
            <ul>
              <li>To comply with a legal obligation</li>
              <li>To protect and defend the rights or property of Telefeast</li>
              <li>
            ...
            <ul>
              <li>By email: navacron@gmail.com</li>
            </ul>
          </div>
        </div>
      </div>
