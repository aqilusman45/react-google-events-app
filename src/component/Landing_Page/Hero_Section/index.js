                    ...
                    <div className="group section-wrap upper" id="upper">
                        <div className="section-2 group">
                            <ul id="images" className="rs-slider">
                                <li className="group">
                                    <a href="#">
                                        <img src={process.env.PUBLIC_URL + '/assets/images/slides/refine/slide1.png'} alt="" />
                                    </a>
                                </li>
                                <li className="group">
                                    <a href="#" className="slide-parent">
                                        <img src={process.env.PUBLIC_URL + '/assets/images/slides/refine/slide2.png'} alt="" />
                                    </a>
                                </li>
                                <li className="group">
                                    <img src={process.env.PUBLIC_URL + '/assets/images/slides/refine/slide3.png'} alt="" />
                                </li>
                            </ul>
                        </div>
                        {/* <!-- /.section-2 --> */}
