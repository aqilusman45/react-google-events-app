    ...
    <div className="row">
      <div className="span6">
        ...
        <ul className="clients">
          <li>
            <a href="#">
                                  <img src={`${process.env.PUBLIC_URL}assets/images/dummies/clients/client1.png`} className="client-logo" alt="" />
                              </a>
          </li>
          <li>
            <a href="#">
                                  <img src={`${process.env.PUBLIC_URL}assets/images/dummies/clients/client2.png`} className="client-logo" alt="" />
                              </a>
          </li>
          <li>
            <a href="#">
                                  <img src={`${process.env.PUBLIC_URL}assets/images/dummies/clients/client3.png`} className="client-logo" alt="" />
                              </a>
          </li>
