...
export const PrivacyPolicy = () => (
  <section id="maincontent">
    <SubIntro heading="Privacy Policy" />
      ...
      <div className="row">
        <div className="span12">
          <div className="row-fluid">
            ...
            <p>
              TestProject ("us", "we", or "our") operates the
              https://testproject-7d280.firebaseapp.com/ website (the
              "Service").
            </p>
            ...
            <p>
              ...
              for TestProject is created with the help of the{" "}
            ...
            <p>TestProject uses the collected data for various purposes:</p>
            <ul>
            ...
            <p>
              ...
              including Personal Data, to Pakistan and process it there.
            </p>
            <p>
            ...
            <p>
              TestProject will take all steps reasonably necessary to ensure
            ...
            <p>
              TestProject may disclose your Personal Data in the good faith
              belief that such action is necessary to:
            </p>
            <ul>
              <li>To comply with a legal obligation</li>
              <li>
                To protect and defend the rights or property of TestProject
              </li>
              <li>
            ...
            <ul>
              <li>By email: aqilusman45@gmail.com</li>
            </ul>
          </div>
        </div>
      </div>
